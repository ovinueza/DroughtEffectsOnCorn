...
Plotly.d3.csv(
  "https://raw.githubusercontent.com/ovinueza/DroughtEffectsOnCorn/master/Exploration/CleanDataFiles/US_Domestic_Corn_Use/US_Domestic_CornClean.csv",
  function(data) {
    let year = [];
    let AlcoholforFuel = [];
    ...
    var traces = [
      ...
      },
      {
        ...
        type: "scatter",
        mode: "none",
        name: "Alcohol for Fuel"
      },
      {
        x: year,
        y: FoodSeedIndustrial,
        stackgroup: "one",
        type: "scatter",
        mode: "none",
        name: "Other, Food, Seed and Industrial"
      }
    ];
